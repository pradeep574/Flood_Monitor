...
public class HeatmapsDemoActivity2 extends BaseDemoActivity2 {
        ...
        if (!isRestore) {
           ...
           getMap().setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
                ...
                public void onMapLongClick(LatLng latLng) {
                    Geocoder myLocation = new Geocoder(HeatmapsDemoActivity2.this, Locale.getDefault());
        ...
        for (int i = 0; i < array.length(); i++) {
          ...
          /*  getMap().setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
                ...
                public void onMyLocationChange(Location location) {
                    ...
                    System.out.println("center LAtitude: "+ mCircle.getCenter().latitude);
                    System.out.println("center Longitude: "+ mCircle.getCenter().longitude);
